...
```{r f5, fig.height=8, fig.width=8, fig.cap="Linear relationships between natural log transformed predictors and the target"}
linearity_log_new
```
...
```{r fig.width=8, fig.cap="Nnatural log transformed predictor distributions"}
Hist_log
```
