...
```{r}
par(mfrow=c(1,2)) 
plot(ROCRPref.org, colorize=TRUE, print.cutoffs.at = seq(0.1, by=0.1), main = "ROC curve of RF Original data")
plot(ROCRPref.syn, colorize=TRUE, print.cutoffs.at = seq(0.1, by=0.1), main = "ROC curve of RF Synthesized data")
```
...
As kernel values depend on the inner products of feature vectors, it's best pratice to scale variables to range of [0, 1] or [-1, 1], which can be accomplished with the preProcess argument of caret's train function.
