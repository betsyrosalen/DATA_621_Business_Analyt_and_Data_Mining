...
Model 2 highest R^2  Model 1 and 3 were lower

coefficients make sense from what we would expect?  Model 3's do not.
...
Our final model's residuals look normally distributed and random, and with constant variability, no indication of homoscedasticity.  
