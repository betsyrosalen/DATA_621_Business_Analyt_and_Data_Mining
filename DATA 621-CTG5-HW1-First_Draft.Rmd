...
output:
  ...
  tufte::tufte_book:
    citation_package: natbib
    latex_engine: xelatex
#bibliography: skeleton.bib - if we decide to create a bibliography file we can uncomment this later
link-citations: yes
---
...
source("./source/script.R") # <<<<<<<<<< NOTE HERE - sets up the script file
```
