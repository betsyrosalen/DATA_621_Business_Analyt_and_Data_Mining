...
$$\text{Specificity} = \frac{\text{True Negativs}}{\text{True Negatives + False Positives}}$$
...
The ROC curve on the figrure below was created using build function (Appendix Chapter 10).
...
The caret ("Classification and REgression Training") package is a toolset for model training.
