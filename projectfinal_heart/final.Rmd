...
For this project, we combine elements of different classification techniques - including logistic regression, random forests, Naive Bayes, and Support Vector Machines models -  that preceding researchers have found fruitful, and to attempt  emulate and possibly improve upon their performance.
