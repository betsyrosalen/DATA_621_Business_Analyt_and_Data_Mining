...
studies <- rbind(c('Hall',  '2000', 'Na?ve Bayes', '83.2'),
                 ...
                 c('Andreeva', '2006', 'Na?ve Bayes', '78.6'),
                 ...
                 c('Palaniappan and Awang', '2007', 'Na?ve Bayes', '95.0'),
                 ...
                 c('Sitar-Taut, Zdrenghea et al.', '2009', 'Na?ve Bayes', '62.0'),
                 ...
                 c('Rajkumar and Reena', '2010', 'Na?ve Bayes', '52.3'),
                 c('Rajkumar and Reena', '2010', 'K Nearest Neighbour', '45.7'),
                 c('Rajkumar and Reena', '2010', 'Decision List', '52.0'),
                 c('Srinivas, Rani et al.', '2010', 'Na?ve Bayes', '84.1'),
                 c('Srinivas, Rani et al.', '2010', 'One Dependency Augmented Na?ve Bayes', '80.5'),
