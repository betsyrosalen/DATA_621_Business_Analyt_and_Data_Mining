...
# [JO: Reviewing script file for imputation strategy, MICE or mean?  Different strategy for STARS?]

b. Create flags to suggest if a variable was missing

c. Transform data by putting it into buckets

# [JO: Consider outlier treatment; assess data for overdispersion, and use neg bin model if so]
# [JO: Use ZI for STARS, given high prevalence of false 0s?]
