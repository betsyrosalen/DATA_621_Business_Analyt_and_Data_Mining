...
```{r, fig.cap="ROC curve using function"}
ROC_func <- function(labels, scores){
  ...
  plot(result$FPR,result$TPR,type="l",main ="ROC Function",ylab="Sensitivity",xlab="1-Specificity",   xlim = c(-.5,1.5))
...
plot(rocCurve , legacy.axes = TRUE,   main = "pROC Package")
```
...
Using pROC function we can also compute the confidence interval (CI) of a ROC curve.  By default, it’s 95%. Computed confidence interval for our curve is 0.7905-0.9101.
