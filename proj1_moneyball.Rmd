...
as.data.frame(describe(train))[c("min", "mean", "median", "max", "sd")]
```
...
```{r}
# I have no idea what happened here either, it looked so good before...
# It probably has to do with my RStudio setup. I didn't make this
# a PDF for this reasoning.
