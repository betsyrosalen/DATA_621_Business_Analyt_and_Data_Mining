...
```{r fig.cap = "Categorical Data Distributions as a Function of TARGET_FLAG"}
bar.cat
```
...
```{r fig.cap="Scatter plot between Numeric Predictors and the TARGET_AMT"}
linearity
```
...
Model 1 only includes categorical variables as this will be easily interpretable and comprehedible when measuring the leading customers.
