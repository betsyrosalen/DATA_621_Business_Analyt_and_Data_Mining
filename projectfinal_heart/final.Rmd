...
SVM models are a form of supervised learning used to create discriminative large-margin classifiers, defining a decision boundary betweemn classes based on a hyperplane.  This hyperplane maximizes the margin, or distance, between the nearest points of different labeled classes while prioritizing correct classification.  The classifier can then be used to predictively categorize unlabeled examples.  
